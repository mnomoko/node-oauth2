...
getAccessToken = async (bearerToken) => {
  return OAuthAccessToken
    .findOne({
      ...
      attributes: ['id', ['access_token', 'accessToken'], ['expires', 'accessTokenExpiresAt'],'scope'],
...
function getClient(clientId, clientSecret) {
  ...
  return sqldb.OAuthClient
    ...
    .then(function (client) {
      ...
      console.error("getClient - Err: ", err)
    });
}
...
function getUser(username, password) {
  return User
    ...
    .then(function (user) {
      return user.validatePassword(password) ? user.toJSON() : false;
    })
    .catch(function (err) {
...
function revokeAuthorizationCode(code) {
  return OAuthAuthorizationCode.findOne({
    ...
    console.error("revokeAuthorizationCode - Err: ", err)
  });
}
...
function saveToken(token, client, user) {
  return Promise.all([
    ...
    .catch(function (err) {
      console.error("saveToken - Err: ", err)
    });
}
